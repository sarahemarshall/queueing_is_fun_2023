...
```{r histogram, fig.height = 4, fig.width = 7, out.width = "100%", eval=FALSE}
for(i in 4:10){
summary_df_long %>% filter(CustomerType != "All", num_staff < 7, num_self==i) %>% ggplot() + geom_histogram(aes(x=Wq), bins=20) +
  ...
  ggsave(paste0("output/simulation_graph_", simulation_length, "_", nreps, "W_q_self", i, ".pdf"), height = 4, width = 7)
}
```
